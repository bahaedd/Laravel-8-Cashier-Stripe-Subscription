      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default credit-card-box">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('order-post') }}" class="data-parsley-validate" id="payment-form" data-parsley-validate>
                    ...
                    <div class="form-group" id="product-group">
                        ...
                        <select name="plane" class="form-control" required data-parsley-class-handler="#product-group">
                            <option value="price_***">Game ($50)</option>
                            <option value="price_***">Movie ($100)</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
